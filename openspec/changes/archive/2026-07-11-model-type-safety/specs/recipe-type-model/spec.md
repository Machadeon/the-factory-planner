...
> Note: React Flow `data as unknown as …` casts in the logistics components and the `factory-storage` serialized-parts cast are unrelated to recipe capabilities and are out of scope.
