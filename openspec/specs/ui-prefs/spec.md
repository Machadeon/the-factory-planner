...
UI preferences that persist across page reloads via localStorage. These preferences are stored without a storage consent gate, consistent with `sfp:autosave-pref`.
